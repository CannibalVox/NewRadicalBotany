...
public class NewRadicalBotanyResourcePack implements IResourcePack {

    protected ModContainer ownerContainer;

    public NewRadicalBotanyResourcePack(ModContainer container) {
    ...
    private String getResourcePath(ResourceLocation location) {
        return "/assets/newradicalbotany/" + location.getResourcePath();
    }

    private InputStream getResourceStream(ResourceLocation resourceLocation) {
        InputStream lis = NewRadicalBotanyResourcePack.class.getResourceAsStream(getResourcePath(resourceLocation));
        return lis;
    }
    ...
    public Set getResourceDomains() {
        return ImmutableSet.of("newradicalbotany");
    }
